...
from flux.sampling import denoise_diffusion_free_noise, denoise_diffusion_sigma_timedependent, denoise_diffusion ,denoise_adaptive, denoist_Ralston, denoise_midpoint, denoise_fireflow, denoise_rf_solver, denoise, get_schedule, prepare, unpack
...
def main(
    ...
    while opts is not None:
        ...
        denoise_strategies = {
            ...
            'diffusion' : denoise_diffusion,
            'diffusion_sigma_time': denoise_diffusion_sigma_timedependent,
